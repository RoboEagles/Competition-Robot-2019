...
public class Vision extends Subsystem {
	...
	Mat image = new Mat(resolution_HEIGHT,resolution_WIDTH, 2);
	...
	public void initVision(){
		...
		try{
			...
			System.out.println("***The camera thread failed to start up***");
		}
	...
	public void updateImage(){		
		...
		// Runs if camera frame couldn't be received
			...
			System.out.println("Couldn't get frame from input stream: " + inputStream.getError());
