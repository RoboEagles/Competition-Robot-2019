...
public class Measurement extends Subsystem {
    ...
    public Measurement() {
        ...
        // robotPDP = new PowerDistributionPanel(0);
        // addChild("robotPDP",robotPDP);
    ...
    AverageFilter hatchCurrent = new AverageFilter(5);
    ...
    public double getHatchCurrent(){
        return hatchCurrent.average();
    }

    public void updateCurrent(){
        hatchCurrent.filter(robotPDP.getCurrent(1));
    }

    public double getRawCurrent(int channel){
