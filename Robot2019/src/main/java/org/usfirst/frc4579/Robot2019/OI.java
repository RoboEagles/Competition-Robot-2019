...
public class OI {
    ...
    public OI() {
        ...
        invertControls_Button = new JoystickButton(joystick, 12);
        invertControls_Button.whenPressed(new invertControls());
        holdHatch_button = new JoystickButton(joystick, 4);
        holdHatch_button.whenPressed(new holdHatch());
        ejectBall_Button = new JoystickButton(joystick, 5);
        ejectBall_Button.whileHeld(new ejectBall());
        intakeBall_Button = new JoystickButton(joystick, 3);
