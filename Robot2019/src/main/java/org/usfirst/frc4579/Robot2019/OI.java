...
public class OI {
    ...
    public JoystickButton intervals_Button;
    ...
    public OI() {
        ...
        intervals_Button = new JoystickButton(joystick2, 9);
        intervals_Button.whenPressed(new liftMode());
        ejectBall_Button = new JoystickButton(joystick2, 5);
        ejectBall_Button.whileHeld(new ejectBall());
        intakeBall_Button = new JoystickButton(joystick2, 3);
        intakeBall_Button.whileHeld(new intakeBall());
        holdHatch_button = new JoystickButton(joystick2, 4);
        ...
        SmartDashboard.putData("liftMode", new liftMode());
